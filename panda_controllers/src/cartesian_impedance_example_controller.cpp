...
#include <panda_controllers/cartesian_impedance_example_controller.h>
...
bool CartesianImpedanceExampleController::init(hardware_interface::RobotHW* robot_hw,
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<panda_controllers::compliance_paramConfig>>(
...
void CartesianImpedanceExampleController::complianceParamCallback(
    panda_controllers::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(panda_controllers::CartesianImpedanceExampleController,
